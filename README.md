...
![status](https://img.shields.io/badge/vers%C3%A3o-0.2.26-orange) ![tests](https://img.shields.io/badge/testes-381%20passando-brightgreen)

## O que já faz (v0.2.26)
...
packages/engine     # núcleo puro TypeScript (zero dependências)
  ...
  test              # 381 testes (âncoras analíticas, normas, equilíbrio global)
