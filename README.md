...
![status](https://img.shields.io/badge/vers%C3%A3o-0.2.41-orange) ![tests](https://img.shields.io/badge/testes-426%20passando-brightgreen)

## O que já faz (v0.2.41)
...
- **Estabilidade e serviço**: γz e parâmetro α (§15.5), **2ª ordem global aproximada
  0,95·γz** (§15.7.2) E **P-Δ ITERATIVO REAL** (forças laterais fictícias por pavimento re-resolvidas até convergir, K fatorizada uma vez — o fator adotado é o MAIOR dos dois, e o P-Δ vale inclusive além do limite γz = 1,30), deslocamentos laterais (tab. 13.3), **flechas de vigas e lajes**
